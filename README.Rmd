[![R build status](https://github.com/UrbanAnalyst/ua-engine/workflows/R-CMD-check/badge.svg)](https://github.com/UrbanAnalyst/ua-engine/actions?query=workflow%3AR-CMD-check)
...
- Permits far larger queries (`valhalla`, for example, is restricted to maximal
  queries of 2,000 pairwise comparisons, `ua-engine` easily extends to
