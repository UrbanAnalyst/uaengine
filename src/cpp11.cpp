...
extern "C" SEXP _uaengine_cpp_pip(SEXP layer, SEXP xy) {
  BEGIN_CPP11
...
extern "C" SEXP _uaengine_cpp_index_sort(SEXP index0) {
  BEGIN_CPP11
...
static const R_CallMethodDef CallEntries[] = {
    {"_uaengine_cpp_index_sort", (DL_FUNC) &_uaengine_cpp_index_sort, 1},
    {"_uaengine_cpp_pip",        (DL_FUNC) &_uaengine_cpp_pip,        2},
    {NULL, NULL, 0}
};
}

extern "C" attribute_visible void R_init_uaengine(DllInfo* dll){
